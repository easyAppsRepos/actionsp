...
var ApiProvider = (function () {
    ...
    ApiProvider.prototype.getHorarioAtencion = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.api2 + '/getHorarioAtencion').subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    ApiProvider.prototype.getYoutubeLink = function (linkIR) {
        ...
        return new Promise(function (resolve) {
            console.log(linkIR);
            _this.http.get(linkIR, { responseType: 'application/json' }).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
                if (err.url) {
    ...
    ApiProvider.prototype.solicitarRR = function (idUsuario) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.post(_this.api2 + '/solicitarRR', JSON.stringify({ estado: 1, idUsuario: idUsuario }), { headers: { 'Content-Type': 'application/json' } }).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
...
var MyApp = (function () {
    function MyApp(storage, platform, statusBar, splashScreen, apiProvider, events, modalCtrl) {
        var _this = this;
        this.storage = storage;
    ...
    MyApp.prototype.CalculateAge = function (fecha) {
        console.log(fecha);
        if (fecha) {
    ...
    MyApp.prototype.goHorarios2 = function () {
        this.nav.setRoot('HorarioatencionPage');
    };
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Platform */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__providers_api_api__["a" /* ApiProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_api_api__["a" /* ApiProvider */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */]) === "function" && _h || Object])
    ], MyApp);
    return MyApp;
